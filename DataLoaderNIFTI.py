...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 12 11:08:37 2022
...
data_path = "/Volumes/Kurtlab/Chiari_Morpho_Segmentation/Segmentation/BrainSeg/BrainMRI_train";

# Read a volume NIFTI file from the BrainSeg data directory
def load_volume_nii(cid, data_path):
    ...
    try:
        cid = int(cid)
        case_id = "T1_LPI_Subj%d".format(cid)
    except ValueError:
        case_id = cid
    ...
    vol = nib.load(os.path.join(case_path, "T1_LPI_Subj%d.nii"))
    return vol
